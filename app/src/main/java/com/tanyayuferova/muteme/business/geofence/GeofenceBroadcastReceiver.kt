...
class GeofenceBroadcastReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
            ...
            // Log the error.
            Timber.e("Unknown transition : $geofenceTransition")
    ...
    private fun sendNotification(context: Context, transitionType: Int) {
        ...
        if (transitionType == Geofence.GEOFENCE_TRANSITION_ENTER) {
            builder.setSmallIcon(R.drawable.ic_volume_off_white)
                .setLargeIcon(BitmapFactory.decodeResource(context.resources,
                    R.drawable.ic_volume_off_white))
                .setContentTitle(context.getString(R.string.silent_mode_activated))
        } else if (transitionType == Geofence.GEOFENCE_TRANSITION_EXIT) {
            builder.setSmallIcon(R.drawable.ic_volume_up_white)
                .setLargeIcon(BitmapFactory.decodeResource(context.resources,
                    R.drawable.ic_volume_up_white))
